...
///
/// R109 — **THE SHADOW IS PER BLOCK, NOT PER FUNCTION, AND THE FIRST CUT FLATTENED IT.** The original
...
pub(crate) fn fninfo(
    ...
    // R109 — THE SIGNATURE IS NOT IN THE BODY'S SCOPE, and the first cut of R106 shadowed it too. A
